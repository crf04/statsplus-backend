...
| `FeatureSettings` | DFS Board, injury-report, and database-first projection-reader exposure gates | `DFS_BOARD_ENABLED`, `INJURY_REPORT_ENABLED`, `PROJECTION_ARCHIVE_READ_ENABLED` (all default `false`) |
