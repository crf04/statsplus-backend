...
| `rank_filter[]` | No | Rank for each opponent filter: `N` keeps the N teams with the highest value of the filter's metric, `-N` the N with the lowest (see Ranking convention) |
