...
& $PythonExe -m statsplus_collector railway-rehearsal --season $Season --cutoff $Cutoff
if ($LASTEXITCODE -ne 0) { throw 'Authenticated Railway compatibility rehearsal failed.' }
