...
| `DFS_ENABLED_PROVIDERS` | Local/test default is all providers; required explicitly in production | Explicit comma-separated internal DFS provider registry (`dabble`, `prizepicks`, `underdog`) |
